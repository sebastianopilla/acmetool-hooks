...
import com.datafaber.acmetool.hooks.CloudflareDNSHook;
import com.datafaber.acmetool.hooks.Hook;
import com.datafaber.acmetool.hooks.PowerDNSHook;
...
public class Main {
  ...
  private static Logger mLogger = LogManager.getLogger("com.datafaber.acmetool.Main");
