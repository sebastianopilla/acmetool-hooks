package com.datafaber.acmetool.hooks;

import com.datafaber.acmetool.DNSTools;
...
/**
 * acmetool hooks using the PowerDNS HTTP API to manipulate records
 *
...
public class PowerDNSHook implements Hook {
  ...
  private static Logger mLogger = LogManager.getLogger("com.datafaber.acmetool.hooks.PowerDNSHook");
